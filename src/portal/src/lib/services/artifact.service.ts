...
export class ArtifactDefaultService extends ArtifactService {
  ...
  _getArtifacts(
    ...
    queryParams = queryParams.set("detail", "true");
    let url: string = `/api/v2/projects/${project_id}/repositories/${repositoryName}/artifacts`;
  ...
  public getArtifactFromId(
    ...
    let url = `/api/v2/projects/${projectName}/repositories/${repositoryName}/artifacts/${artifactId}`;
  ...
  public deleteArtifact(
    ...
    let url: string = `/api/v2/projects/${projectName}/repositories/${repositoryName}/artifacts/${artifactId}`;
    return this.http
  ...
  public addLabelToImages(
    ...
    /api/v2/projects/${projectName}/repositories/${repoName}/artifacts/${artifactId}/labels`;
    return this.http
  ...
  public deleteLabelToImages(
    ...
    let _addLabelToImageUrl = `
    /api/v2/projects/${projectName}/${repoName}/artifacts/${artifactId}/labels/${labelId}`;
    return this.http
